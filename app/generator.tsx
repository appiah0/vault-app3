  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      <View style={{
        ...
        <Text style={{ color: theme.text, fontSize: 18, fontWeight: '800' }}>Password Generator</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 60 }}>
        ...
        <View style={{
          ...
          <Text style={{
            color: theme.accent,
            fontSize: opts.passphrase ? 18 : 20,
        ...
        <View style={{
          ...
          <View style={{ padding: 16, borderBottomWidth: 1, borderBottomColor: theme.border }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
              ...
              <Text style={{
                color: theme.accent, fontSize: 16, fontWeight: '800',
            ...
            <View style={{
              height: 4, backgroundColor: theme.bg4, borderRadius: 2, overflow: 'hidden',
            }}>
              <View style={{
                height: 4, borderRadius: 2,
                width: `${((opts.length - 8) / (64 - 8)) * 100}%`,
              ...
              {[8, 12, 16, 20, 24, 32, 48, 64].map(n => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    backgroundColor: opts.length === n ? theme.accentSoft : 'transparent',
                  }}
                >
                  <Text style={{
                    color: opts.length === n ? theme.accent : theme.text3,
              ...
              {history.slice(1).map((p, i) => (
                <TouchableOpacity
                  ...
                  style={{
                    flexDirection: 'row', alignItems: 'center',
                    padding: 14,
                    borderBottomWidth: i < history.length - 2 ? 1 : 0,
                    borderBottomColor: theme.border,
                  }}
                >
                  <Text style={{
                    flex: 1, color: theme.text2, fontFamily: 'monospace',
                    fontSize: 13,
                  }} numberOfLines={1}>
                    {p}
                  </Text>
